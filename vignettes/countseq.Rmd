...
- name: "Davide Raffaelli"
  ...
  email: davide2.raffaelli@mail.polimi.it
date: "`r Sys.Date()`"
output: BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{Get overall count of sequences of DNA that match in 
  regions of a genome}
...
If you need to sort the matrix of overall counts, because you have to do some
operations which require a ordered matrix, this package provide the function
sortSeqsMatrix. You have to just pass the matrix and tell you want the matrix
sorted in decreasing or increasing way.
...
writeToFile function. You can also read this file in order to get the matrix 
when you need, with readFromFile function.
...
writeToFile(mat_check, "matrix.txt")
